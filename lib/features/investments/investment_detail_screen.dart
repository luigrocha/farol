    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Container(width: 48, height: 48, decoration: BoxDecoration(color: const Color(0xFFEC7000), borderRadius: BorderRadius.circular(12)), child: const Center(child: Text('I', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 18)))),
            const SizedBox(width: 12),
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(productName, style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800)),
              Text('Itaú Unibanco PN', style: TextStyle(fontSize: 12, color: colors.onSurfaceSoft)),
            ]),
          ]),
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: ['1D','5D','1M','6M','1Y','MAX'].asMap().entries.map((e) {
                final active = e.key == 2;
                return Padding(padding: const EdgeInsets.symmetric(horizontal: 4), child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                  decoration: BoxDecoration(color: active ? AppTheme.primaryColor : Colors.transparent, borderRadius: BorderRadius.circular(99)),
                  child: Text(e.value, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: active ? Colors.white : colors.onSurfaceSoft)),
                ));
              }).toList()),
            ]),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), gradient: const LinearGradient(colors: [AppTheme.primaryContainer, AppTheme.primaryColor])),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                _PositionStat(label: 'GAIN', value: '+13.3%', color: Color(0xFF9BF6BA)),
              ]),
            ]),
          ),
      ...
      bottomSheet: Container(
        ...
        child: Row(children: [
          Expanded(child: ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: AppTheme.secondaryColor, foregroundColor: Colors.white, minimumSize: const Size(0, 50), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)), elevation: 0), child: const Text('Buy', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)))),
          const SizedBox(width: 10),
          Expanded(child: OutlinedButton(onPressed: () {}, style: OutlinedButton.styleFrom(side: const BorderSide(color: AppTheme.errorColor, width: 1.5), foregroundColor: AppTheme.errorColor, minimumSize: const Size(0, 50), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))), child: const Text('Sell', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)))),
        ]),
      ),
    );
  }
...
class _StatLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(border: last ? null : Border(bottom: BorderSide(color: colors.surfaceLow))),
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(label, style: TextStyle(fontSize: 12, color: colors.onSurfaceSoft)),
        Text(value, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: color ?? colors.onSurface)),
      ]),
    );
  }
}
