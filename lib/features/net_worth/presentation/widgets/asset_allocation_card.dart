...
class AssetAllocationCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final total =
        alloc.banks + alloc.investments + alloc.fgts + alloc.patrimony;
            ...
            Center(
              child: Padding(
                ...
                child: Text(context.l10n.noAccountsRegistered,
                    style:
                        TextStyle(color: colors.onSurfaceFaint, fontSize: 14)),
              ),
            )
          else ...[
            SizedBox(
              ...
              child: Stack(alignment: Alignment.center, children: [
                ...
                Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  isPrivate
                      ...
                      : BrlText(
                          value: total, fontSize: 16, color: colors.onSurface),
                ]),
              ]),
            ),
            const SizedBox(height: 16),
            ...sections.map((b) =>
                _LegendRow(bucket: b, total: total, isPrivate: isPrivate)),
          ],
        ],
      ),
    );
...
class _LegendRow extends StatelessWidget {
  ...
  const _LegendRow(
      {required this.bucket, required this.total, required this.isPrivate});
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Text('${pct.toStringAsFixed(1)}%',
            style:
                GoogleFonts.manrope(fontSize: 12, color: colors.onSurfaceSoft)),
        ...
        isPrivate
            ? Text('•••',
                style: GoogleFonts.manrope(
                    ...
                    color: colors.onSurface))
            : BrlText(
                value: bucket.value, fontSize: 13, color: colors.onSurface),
      ]),
    );
  }
}
