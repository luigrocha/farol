...
### Categoría: Movimientos & Beneficios

| String EN | Ubicación | PT (Português) | ES (Español) |
|-----------|-----------|---|---|
| `Recent Transactions` | `swile_screen.dart:1` | Transações Recentes | Movimientos Recientes |
| `Monthly Spending` | `swile_screen.dart:1` | Movimentos Mensais | Movimentos Mensuales |
